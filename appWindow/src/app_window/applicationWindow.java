...
public class applicationWindow {
	...
	public applicationWindow() {
		...
		//for(int i=0 ; i<=72 ; i++) {radioButton = new JRadioButton[72];}
		initialize();
	}
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 885, 701);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setBounds(34, 89, 210, 585);
		...
		radioButton[46].setBackground(new Color(0,0,0,0));
		...
		JButton btnEnter = new JButton("Reported");
		btnEnter.setBounds(111, 215, 114, 25);
		panel_20.add(btnEnter);
		
		JButton btnSync = new JButton("Sync");
		btnSync.setBounds(321, 215, 114, 25);
		panel_20.add(btnSync);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("/home/jyotir/Academics/Sem 2-2/CRIS  (1).jpg"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("/home/jyotir/Academics/Sem 2-2/RailLogo.png"));
		...
		lblNewLabel_2.setIcon(new ImageIcon("/home/jyotir/Academics/Sem 2-2/newbackground1.jpg"));
		lblNewLabel_2.setBounds(12, 0, 868, 691);
